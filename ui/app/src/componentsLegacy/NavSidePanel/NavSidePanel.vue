  ...
  setup(props) {
    ...
    return () => (
      <div class="portrait:hidden overflow-y-scroll font-sans flex-row align-center justify-center container w-sidebar h-full z-10 bg-gray-base text-white fixed left-0 top-0 bottom-0">
        <div class="w-full h-full text-center flex flex-col flex-1 justify-between">
          <div class="top">
          ...
          <div class="bottom">
            ...
            <button class="mt-[22px] text-xs text-bold flex items-center">
              <AssetIcon icon="interactive/wallet" class="w-[20px] h-[20px] px-1 mr-[10px]" />
            </button>
